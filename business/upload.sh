...
URL=$(curl -s -H "Content-Type: application/json" -d '{"userName": "'$userName'", "fileName": "'$fileName'"}' https://ia0lhznrre.execute-api.ap-south-1.amazonaws.com/dev/upload-url | jq -r '.url')
